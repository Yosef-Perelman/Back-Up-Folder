...
def main():
    ...
    while True:
        ...
        # if its client in second or more connection receive and send updates
        # first - receive
        else:
            ...
            # from now on - send updates from the updates map
            ...
            updates_map[identifier][computerIdentifier].clear()
